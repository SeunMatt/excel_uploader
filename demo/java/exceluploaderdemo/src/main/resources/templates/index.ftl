...
<header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar" style="background-color:#563D7C;">
    ...
    <div class="navbar-nav-scroll">
        <ul class="navbar-nav bd-navbar-nav flex-row">
            ...
            <li class="nav-item">
                <a class="nav-link" href="http://wallet.ng/pay/ossmatt">Support</a>
            </li>
        </ul>
    </div>
    ...
    <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
        <li class="nav-item nav-link">
            Built with <span style="color: #ff000085;" class="fa fa-heart"></span>  by <a class="" target="_blank" href="https://smattme.com/seunmatt">Seun Matt</a>
        </li>
    </ul>
</header>
